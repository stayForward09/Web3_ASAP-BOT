		...
		<section className="flex px-6 py-14 smm:py-20 md:py-28 text-center flex-col">
			...
			<div className="py-10 smm:pt-16 md:pt-[100px] flex items-center justify-center">
				<div className="relative w-[270px] smm:w-[400px] md:w-[600px] lg:w-[900px] xl:w-[1200px]">
					...
					<div className="overflow-hidden hidden xl:flex absolute bg-indigo-800 top-[43px] left-[182px] w-[866px] h-[540px]"><LaptopVideo /></div>
					<div className="overflow-hidden hidden lg:flex xl:hidden absolute bg-indigo-800 top-[32px] left-[136px] w-[649px] h-[406px]"><LaptopVideo /></div>
					<div className="overflow-hidden hidden md:flex lg:hidden absolute bg-indigo-800 top-[21px] left-[91px] w-[433px] h-[271px]"><LaptopVideo /></div>
					<div className="overflow-hidden hidden smm:flex md:hidden absolute bg-indigo-800 top-[15px] left-[60px] w-[289px] h-[179px]"><LaptopVideo /></div>
					<div className="overflow-hidden flex smm:hidden absolute bg-indigo-800 top-[10px] left-[40px] w-[196px] h-[122px]"><LaptopVideo /></div>
				</div>
			</div>
		</section>
	)
